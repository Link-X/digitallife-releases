...
本项目采用 **[PolyForm Noncommercial License 1.0.0](https://polyformproject.org/licenses/noncommercial/1.0.0/)**（source-available，非 OSI 开源）。

- **非商业用途免费**：个人学习、研究、业余使用，以及非营利、教育科研、政府机构使用
- **商业用途需许可**：请事先联系作者 **许道斌**（<15555537368xu@gmail.com>）获取商业授权
